...
const MdexRouter = artifacts.require("PancakeFactory");
const MdexRouter = artifacts.require("PancakeRouter");
...
module.exports = async function (deployer, network, accounts) {
    ...
    if (network == 'development' || network == 'bsctest') {
        ...
        // WBNB should be saved in addressJson after deploying mdx.
